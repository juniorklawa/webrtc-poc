...
export default function CallScreen({ setScreen, screens, roomId }) {
  ...
  const startCall = async (id) => {
    // cria a conexão peer local com a configuração dos ice servers
    const localPC = new RTCPeerConnection(configuration);
    // adiciona a stream locall na conexão peer local
    ...
    // Adicione os candidatos de audio e video para o local peer connection
